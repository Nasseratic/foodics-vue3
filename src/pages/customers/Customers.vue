...
export default defineComponent({
  ...
  setup() {
    ...
    const { isLoading, loadedData: customers, refetch } = useCustomersList(page, filters);
    ...
    return { openAddModal, closeAddModal, changePage, showAddModal, isLoading, customers, filtersForm, filters, updateFilters, tableHead };
  },
});
</script>
